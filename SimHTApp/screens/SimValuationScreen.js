...
const SimValuationScreen = ({ navigation }) => {
                        ...
                        valueSimData && (
                            <View testID='CardContainer' style={styles.cardContainer} >
                                ...
                                <View testID='CardContent' style={styles.cardContent} >
                                    <View >
                                        <Text style={{ fontSize:  responsiveScreenFontSize(2.7), color: 'white', fontWeight: 'bold' }}> {valueSimData.simNumber}</Text>
                                    </View>
                                    <View style={{ flex: 1, flexDirection: 'column', justifyContent:"flex-end"}}>
                                        ...
                                        <Text style={{ fontSize:  responsiveScreenFontSize(2.5), color: 'white', fontWeight: 'bold', textAlign: "center" }}>{`${ConvertCurrency(valueSimData.simValue)}`}</Text>
                                    </View>
                                </View>
                            </View>
                        )
...
export default SimValuationScreen;