...
const AutionScreen = (props) => {
    const { myAuctionData, GetMyAuction } = useContext(AutionContext);
    ...
    const Aucting = () => {
        ...
        return (
            ...
            >
                <Text style={[styles2.buttonText, activeButton === 'Aucting' && styles2.activeText]}>Thành Công</Text>
            </TouchableOpacity>
        );
    }
                            ...
                            <View className="flex-row items-center justify-between">
                                ...
                                <View className="flex-row">
                                    ...
                                    <View className="bg-stone-200 items-center px-2 rounded-xl">
                                        <Text>
                                            <Ionicons name="eye" color="grey" size={responsiveFontSize(1.8)}></Ionicons>
                                            <Text style={{ fontSize: responsiveFontSize(1.8) }}>
                                                {` ${data.bidderNum} ng`}
                                            </Text>
                                        </Text>
    ...
    const Title = () => {
        return (
            <View className="flex-1 items-center justify-center">
                <Text style={{ color: "white", fontWeight: "bold", fontSize: responsiveFontSize(2.2) }}>Đấu giá của tôi</Text>
            </View>
